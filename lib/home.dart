...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  Container(
                    ...
                    child: ListWheelScrollViewX(
                      ...
                      children: [
                        ...
                        ModelContainer("모델3",5,6),
                        ModelContainer("모델4",7,0),
      ...
      //           //     autoPlay: true,
      //           //   ),
      //           //   items: [['모델1','구급차','동물','사람','교통수단','어린이보호구역'], ['초보자 추천 모델','어린이 보호 구역'], ['사람 추천 모델','a']].map((list) {
      ...
      //           //             width: 150,
      //           //             margin: EdgeInsets.only(right: 10),
      //           //             height: MediaQuery.of(context).size.height * 0.20 - 50,
      //           //             child: Card(
      //           //               elevation: 10,
      //           //               borderOnForeground: true,
      //           //               child: Padding(
